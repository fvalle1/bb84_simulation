...
void bb84_simulation(){
    ...
    configs.emplace_back(ConfigSimulation(false, 100, 1000, false, 0.1, [&](){return gRandom->Gaus(0, 0.1);}));
    configs.emplace_back(ConfigSimulation(false, 100, 1000, false, 0.3, [&](){return gRandom->Gaus(0, 0.3);}));
    configs.emplace_back(ConfigSimulation(false, 100, 1000, false, 1.4, [&](){return gRandom->Gaus(0, 1.4);}));
