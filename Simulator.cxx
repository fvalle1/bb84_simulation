        ...
        :fConfiguration()
{
    ...
    fChannels = new Channel *[2];   // di default creo 2 canali di default.
...
Simulator* Simulator::ShowResults(TCanvas *cx) {//get thing from file and plot them on cx
    ...
    if (cx) {
        ...
        auto NVsNHist = dynamic_cast<TGraphErrors*>(file.Get(TString::Format("%s_%s", fAlteredVsSentName, fConfiguration.fInfos.c_str())));
